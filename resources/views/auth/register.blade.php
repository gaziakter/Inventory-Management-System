...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Register | Upcube - Register</title>
                    ...
                    <div class="card-body">
                        ...
                        <div class="p-3">
                            <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group mb-3 row">
                                    <div class="col-12">
                                        <input id="password_confirmation" class="form-control" name="password_confirmation" type="password" required="" placeholder="password">
                                    </div>
                                </div>
