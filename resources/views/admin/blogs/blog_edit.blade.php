                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('update.blog')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="blog_description" class="form-control" rows="3">{{$EditBlog->blog_description}}</textarea>
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="show_picture" src="{{asset($EditBlog->blog_image)}}" alt="avatar-5" class="rounded avatar-lg">
                                </div>
                            </div>
                            <!-- end row -->
