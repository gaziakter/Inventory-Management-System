                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('store.profile')}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input name="profile_picture" class="form-control" type="file" id="input_profile_picture">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="show_picture" src="{{(!empty($editData->profile_picture))? url('upload/admin_images/'.$editData->profile_picture):url('upload/no_image.png')}}" alt="avatar-5" class="rounded avatar-lg">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                <div class="col-sm-10">
                                    <input class="btn btn-info btn-rounded waves-effect waves-light" type="submit" value="Update Profile">
                                </div>
                            </div>
                            <!-- end row -->
                        </form>
